...
//This returns a copy of the array NOT THE OBJECT.
//export getOrders = () => {
  //  return [...database.customOrders]}

//When user is selecting choices for thier custom order, state changes, so use this object to keep track of changes to the state.
